        ...
        <div className="space-y-6 overflow-y-auto pr-2 custom-scrollbar flex-1">
          ...
          <div className="flex justify-between items-end bg-white/[0.02] p-4 rounded-xl border border-white/5">
            ...
            <div className="flex flex-col items-end">
              ...
              <p className="text-[9px] text-gray-600 uppercase">{t("insights.vsYesterday")}</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/5">
            ...
            <div className="flex justify-between items-center mb-4 text-xs font-medium text-gray-300">
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[10px]">{`${t("insights.delaying")} > 60%`}</span>
              </div>
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/5">
            <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-3">
              {t("insights.trendingExcuses")}
            </p>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-300">📱 "{t("insights.excuse1")}"</span>
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-300">🛋️ "{t("insights.excuse2")}"</span>
                <span className="text-xs font-medium text-gray-500">
                  18.2k logs
                </span>
              </div>
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-300">☕ "{t("insights.excuse3")}"</span>
                <span className="text-xs font-medium text-gray-500">
                  12.8k logs
                </span>
              </div>
