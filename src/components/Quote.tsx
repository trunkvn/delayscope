    ...
    <div className="absolute top-4 md:top-6 left-4 md:left-8 z-10 pointer-events-none flex flex-col items-start max-w-[calc(100%-2rem)] md:max-w-sm">
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-2.5 h-2.5 md:w-3 md:h-3">
          ...
          ></div>
          <div
            className={`relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full ${locationStatus === "granted" ? "bg-blue-400 shadow-[0_0_10px_rgba(59,130,246,1)]" : "bg-gray-400 shadow-[0_0_10px_rgba(156,163,175,1)]"}`}
          ></div>
        </div>
        ...
        {locationStatus === "granted" && (
          <div className="relative flex items-center justify-center w-5 h-5 md:w-6 md:h-6 rounded-full bg-white/10 group-hover:bg-white/20 transition-colors">
            <svg
              className="w-3 h-3 md:w-3.5 md:h-3.5 text-blue-300 group-hover:text-white group-hover:translate-x-0.5 transition-all"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
